    ...
    <div>
      <div className="row">
        <div className="col-sm-12">
          <span className="mb-3 standings-pool-name text-info">Pool A</span>
          <PointsTable teams={props.teams.filter(t => t.pool === 'Pool A')} />
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12">
          <span className="mb-3 standings-pool-name text-info">Pool B</span>
          <PointsTable teams={props.teams.filter(t => t.pool === 'Pool B')} />
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12">
          <span className="mb-3 standings-pool-name text-info">Pool C</span>
