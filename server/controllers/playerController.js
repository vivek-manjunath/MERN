...
module.exports = {
    ...
    findByTeam: function(req, res){
        Player.find({ "teamsPlayedFor._id": mongoose.Types.ObjectId(req.params.id) , "teamsPlayedFor.isActiveMember": true})
    ...
    create: function(req, res){
        ...
        _newPlayerInfo = {..._newPlayerInfo, teamsPlayedFor: [{_id: _newPlayerInfo.team, isActiveMember: true}]}        
